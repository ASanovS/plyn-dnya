## v2.1.2 — HUD-шапка (аватар + S.P.E.C.I.A.L.)
- Компактний header на головному екрані: аватар зліва, 7 характеристик справа.
- Бедж рівня поверх аватара, міні-смуга XP.
- Плейсхолдер `/special/badge.jpg`; готово до `profiles.avatar_url` (якщо колонки ще немає — фетч без неї).
- Теми techno / steampunk змінюють форму кільця аватара.
- На телефоні дубль-сітка в нижньому блоці характеристик ховається; радар лишається.
